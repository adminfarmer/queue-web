...
export class QueueService {
  ...
  //Ubonket10
  async getWorkingRunNumber(servicePointId: any, token: any = null) {
    const _url = `${this.apiUrl}/queue/working/runnumber/${servicePointId}`;
  ...
  //Ubonket10
  async getcreate(servicePointId: any) {
    const _url = `${this.apiUrl}/queue/create/${servicePointId}`;
    return this.httpClient.get(_url, this.httpOptions).toPromise();
  }
